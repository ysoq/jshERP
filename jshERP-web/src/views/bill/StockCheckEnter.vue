...
<!--              <a-divider v-if="btnEnableList.indexOf(1)>-1" type="vertical" />-->
        ...
        <!-- table区域-end -->
        <!-- 表单区域 -->
        <StockCheckEnterModal ref="modalForm" @ok="modalFormOk" @close="modalFormClose"></StockCheckEnterModal>
...
<!--power by jishenghua-->
<script>
  import StockCheckEnterModal from './modules/StockCheckEnterModal.vue'
