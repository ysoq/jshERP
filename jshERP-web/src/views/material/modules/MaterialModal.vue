        ...
        <a-tabs default-active-key='1' size='small'>
          <a-tab-pane key='1' tab='基本信息' id='materialHeadModal' forceRender>
            <a-row class='form-row' :gutter='24'>
              ...
              <a-col :md='6' :sm='24'>
                <a-form-item :labelCol='labelCol' :wrapperCol='wrapperCol' label='助记码' data-step='7'
                             data-title='助记码'
              ...
              <a-col :md='6' :sm='24'>
                <a-form-item :labelCol='labelCol' :wrapperCol='wrapperCol' label='基础重量' data-step='9'
                             data-title='基础重量'
              ...
              <a-col :md='6' :sm='24'>
                <a-form-item :labelCol='labelCol' :wrapperCol='wrapperCol' label='保质期' data-step='10'
                             data-title='保质期'
              ...
              <a-col :md='6' :sm='24'>
                <a-form-item :labelCol='labelCol' :wrapperCol='wrapperCol' label='制造商' data-step='12'
                             data-title='制造商'
              ...
              <a-col :md='6' :sm='24'>
                <a-form-item :labelCol='labelCol' :wrapperCol='wrapperCol' label='序列号' data-step='13'
                             data-title='序列号'
              ...
              <a-col :md='6' :sm='24' v-if='!model.id'>
                <a-form-item :labelCol='labelCol' :wrapperCol='wrapperCol' label='多属性' data-step='15'
                             data-title='多属性'
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.$nextTick(() => {
        ...
        this.form.setFieldsValue({ 'inOutItemId': `${this.model.inOutItemId || ''}` })
      ...
      if (this.maxBarCodeInfo === '') {
        getMaxBarCode({}).then((res) => {
          if (res && res.code === 200) {
            ...
            target.setValues([{
              rowKey: row.id,
              values: { barCode: this.maxBarCodeInfo, commodityUnit: unit ? unit : '' }
            }])
          }
        })
      } else {
    ...
    changeDecimalByValue(row) {
      ...
      if (row.commodityUnit === basicUnit) {
        this.$refs.editableMeTable.getValues((error, values) => {
          let mArr = values, basicPurchaseDecimal = '', basicCommodityDecimal = '', basicWholesaleDecimal = '',
            basicLowDecimal = ''
    ...
    batchSetStockModalFormOk(stock, batchType) {
      ...
      for (let i = 0; i < arr.length; i++) {
        let depotInfo = {
          name: arr[i].name, initStock: arr[i].initStock,
